          ...
          <div className={`flex gap-10 max-lg:flex-col flex-row-reverse mt-10`}>
            ...
            <div className="content space-y-5">
              ...
              <p className="text-xl max-sm:text-base">
                ...
                triển khai. Vì thế dịch vụ lau kính chuyên nghiệp Trần Lê ra đời
                để dẹp bỏ các lo ngại này. Đồng thời mang lại nhiều lợi ích như:
                <br />
                <span className="font-bold">Tăng tính thẩm mỹ</span>: một tòa
                nhà với bề mặt kính bên ngoài bị bám đầy bụi bẩn do lâu ngày đã
                không vệ sinh sẽ nhìn rất cũ kỹ, làm giảm khả năng ánh xạ ánh
                sáng, làm cho không gian bên trong bị thiếu sáng & thiếu sức
                sống. Vì thế vệ sinh kính ngoài tòa nhà sẽ giúp trả lại vẻ “long
                lanh” vốn có ban đầu.
                <br />
                <span className="font-bold">Đảm bảo sự an toàn</span>: làm sạch
                mặt dựng kính định kì sẽ giúp cho quản lý tòa nhà phát hiện kịp
                thời các vết nứt, hở ron hay men kính bị mất,… từ đó khắc phục
                kịp thời để đảm bảo sự an toàn khi sử dụng.
                <br />
                <span className="font-bold">Giúp tiết kiệm chi phí</span>: so
                với thay mới thì việc vệ sinh, kiểm tra định kì và sửa chữa kịp
                thời luôn tiết kiệm chi phí hơn, đảm bảo tuổi thọ cho kính hơn.
                Giảm thiểu các quy trình phức tạp như tìm kính cùng loại, lên kế
                hoạch tháo gỡ kính cũ, thuê nhân công lắp kính mới,… tới giai
                đoạn dọn dẹp sau đó.
              </p>
            </div>
          </div>
