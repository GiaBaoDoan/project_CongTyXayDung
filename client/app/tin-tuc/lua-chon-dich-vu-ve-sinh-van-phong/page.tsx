...
const LuaChonDichVuVeSinhVanPhong = () => {
  return (
    <section>
      <div className="space-y-5 border-b pb-5 border-gray-200">
        ...
        <h1 className="text-3xl font-bold text-greenTheme">
          Vệ sinh chung cư sau xây dựng, bạn cần phải thực hiện những công việc
          nào đầu tiên?
        </h1>
      </div>
      <div className="mt-10 space-y-5">
        ...
        <p className="text-xl max-sm:text-base">
          ...
          cắt hay đo đạc,…Nhiệm vụ cụ thể của người thực hiện là phải phân loại
          chúng theo yêu cầu. Sau đó sẽ làm sạch, đóng gói và cất giữ những vật
          dụng cần thiết hay còn dùng được. Đồng thời, bạn sẽ loại bỏ những vật
          dụng phế thải, không dùng được nữa.
        </p>
      </div>
    </section>
  );
...
export default LuaChonDichVuVeSinhVanPhong;
