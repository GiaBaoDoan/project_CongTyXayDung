  ...
  return (
    <main>
      ...
      <section className="px-5 py-20">
        <div>
          <p className="title text-3xl max-md:text-2xl max-ms:text-base text-greenTheme border-l-[3px] border-greenTheme pl-5">
            <i>
              ...
              cầu về các dịch vụ phục vụ cho cuộc sống của con người ngày càng
              nhiều. Nhằm đáp ứng nhu cầu đó các dịch vụ{" "}
              <span className="font-bold">
                giúp việc nhà, dọn vệ sinh văn phòng
              </span>
              , vệ sinh công nghiệp,… ra đời ngày càng nhiều. Tuy nhiên, để chọn
              được một địa chỉ cung cấp dịch vụ vệ sinh uy tín, chất lượng không
              hề đơn giản. <br /> <br /> <br /> Dịch vụ vệ sinh ngày càng được
              các công ty lựa chọn
            </i>
          </p>
        </div>
        <div className="space-y-5 mt-10">
          <h3 className="text-3xl font-bold max-sm:text-lg">
          ...
          <p className="text-2xl max-sm:text-lg">
            ...
            sợi nhỏ để giảm ô nhiễm chéo. Vì vậy, khi đến với các dịch vụ của
            chúng tôi khách hàng hoàn toàn có thể yên tâm về các hóa chất khi vệ
            sinh.
          </p>
          <Image
            src={"/banner2.jpg"}
          ...
          <p className="text-2xl max-sm:text-lg">
            ...
            và tin tưởng của khách hàng. <br /> Công ty chúng tôi luôn hoạt động
            với phương châm “Mang đến không gian xanh cho mọi người”. Trước khi
            ký hợp đồng thực hiện dịch vụ vệ sinh chúng tôi luôn báo giá rõ ràng
            và không phát sinh bất kỳ khoản chi phí nào thêm. <br /> Chúng tôi
          ...
          <p className="text-2xl max-sm:text-lg">
            ...
            hàng lựa chọn. <br /> Hy vọng, những thông tin về địa chỉ vệ sinh
